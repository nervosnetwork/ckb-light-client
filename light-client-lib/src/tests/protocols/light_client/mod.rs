...
use crate::{
    ...
    storage::db::StorageGeneralOperations,
    tests::{
        prelude::*,
...
#[tokio::test]
async fn build_prove_request_content() {
    let chain = MockChain::new_with_dummy_pow("test-light-client");
    ...
    // Test different total difficulties.
    {
        ...
        for diff in 1u64..10 {
            ...
            let prove_request = protocol
                .build_prove_request_content(&peer_state, &verifiable_header)
                .await;
