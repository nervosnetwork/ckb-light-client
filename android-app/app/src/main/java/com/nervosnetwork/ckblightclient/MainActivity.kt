...
class MainActivity : AppCompatActivity() {
    ...
    private fun startLightClientService() {
        val serviceIntent = Intent(this, LightClientService::class.java).apply {
        ...
        Log.d(TAG, "Light client service start requested")
    }
